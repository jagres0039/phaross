...
const logger = {
  ...
  banner: () => {
    ...
    console.log('-------------------------------------------------');
    console.log(' bot jagrestek | megaldrops 2025');
    console.log('-------------------------------------------------');
...
const retryAsync = async (fn, args = [], retries = 3, delayMs = 1000) => {
...
const countdown = async () => {
  const totalSeconds = 24 * 60 * 60; // 24 jam
  logger.info('TUNGGU SEHARI MAMANG');
